        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3">
                ...
                <form action="{{ route('projects.destroy', $project->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this project?');" class="m-0">
                    @csrf
                    @method('delete')
                    <button type="submit" class="bg-red-500 hover:bg-red-600 text-white px-5 py-2.5 rounded-lg font-medium shadow-sm transition inline-flex items-center justify-center">
                        Delete
                    </button>
                </form>
